...
def fetch_populations(server: dict, variation_db_name: str) -> str:
    ...
    Args:
        ...
        variation_db_name (str): variation database name
    Returns:
        str: population string from database
    """
    query = "SELECT name, description, collection, population_id from population;"
...
def fetch_super_population(server: dict, variation_db_name: str, pop_id: str) -> str:
    """
     Fetch super-population data from database

    Args:
        server (dict):  database config
        variation_db_name (str): variation database name
        pop_id (str): population identifier
    Returns:
        str: super-population string from database
    """
...
def fetch_sub_population(server: dict, variation_db_name: str, pop_id: str) -> str:
    """
    Fetch sub-population data from database
    ...
    Args:
        ...
        pop_id (str): population identifier
    Returns:
        str: sub-population string from database
    """
...
with open("assemblies.txt") as fd:
    ...
    for row in rd:
        ...
        for pop in populations_data:
            ...
            p_map["super_population"] = (
                {"name": super_population} if super_population else None
            )
            if super_population:
